...
This model shows that as temperature increases as does cricket chirping. The model accounts for about 99% of the variance of the data. Compared to the first model which accounted for 92%, meaning that although both models are good this model is more reliable. 
